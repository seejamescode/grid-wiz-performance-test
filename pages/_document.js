...
export const title = "Grid Wiz Performance Test";
const description =
  "Finding the most user-centered and performant way to use CSS Grid fallback tools. A demo for AustinJS Meetup January 2019.";
const url = `https://grid-wiz-performance-test.now.sh`;
...
export default class MyDocument extends Document {
  ...
  static getInitialProps({ renderPage, req }) {
    ...
    return { ...page, styleTags, useragent };
  }
